...
CREATE TABLE `photos` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk14_idx` (`did`),
  CONSTRAINT `fk14` FOREIGN KEY (`did`) REFERENCES `pets` (`did`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `photos` VALUES (1,3,'charlie.jpg'),(2,3,'jaks.jpg'),(3,3,'sp.jpg');
