...
CREATE TABLE `vaccination` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk4_idx` (`did`),
  CONSTRAINT `fk4` FOREIGN KEY (`did`) REFERENCES `pets` (`did`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `vaccination` VALUES (2,3,'Six in One','2025-04-23','To prevent infection yearly dosage',NULL),(3,3,'Anti Tick 6 mg','2025-04-24','Due to summer weather for prevention of ticks in Jackie',NULL);
